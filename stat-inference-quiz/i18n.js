/* scRNA-seq Quiz · i18n
 * 與 ../scrna-interactive-tutorial-main/i18n.js 同邏輯：
 * - localStorage key 'statinf_lang'（與教學共用，切換能跨頁同步）
...
(function(){
  ...
  const STR = {
    appTitle:        { zh:"🧬 Statistical Inference 互動考題", en:"🧬 Statistical Inference Interactive Quiz" },
    ...
    quizAllChapters: { zh:"Statistical Inference 互動考題（全部章節）", en:"Statistical Inference Interactive Quiz (All Chapters)" },
    quizErrataTitle: { zh:"Statistical Inference 互動考題", en:"Statistical Inference Interactive Quiz" },
